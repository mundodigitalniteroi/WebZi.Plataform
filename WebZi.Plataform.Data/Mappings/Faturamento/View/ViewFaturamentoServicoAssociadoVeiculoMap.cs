...
{
    public class ViewFaturamentoServicoAssociadoVeiculoMap : IEntityTypeConfiguration<ViewFaturamentoServicoAssociadoVeiculoModel>
    {
        public void Configure(EntityTypeBuilder<ViewFaturamentoServicoAssociadoVeiculoModel> builder)
        {
            builder.HasNoKey()
