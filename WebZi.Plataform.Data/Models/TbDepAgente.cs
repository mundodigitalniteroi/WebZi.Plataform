...
public partial class TbDepAgente
{
    ...
    public virtual TbDepAutoridadesResponsavei AutoridadeResponsavel { get; set; }

    public virtual TbDepAgentesImagemAssinatura TbDepAgentesImagemAssinatura { get; set; }
