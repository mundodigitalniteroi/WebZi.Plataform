...
public partial class VwDepRepGuiaPagamentoEstadiaReboque
{
    ...
    public string GrvDataHoraRemocao { get; set; }

    public string GrvDataHoraGuarda { get; set; }
    ...
    public string EmpresaAssociadaNome { get; set; }

    public string EmpresaAssociadaCnpj { get; set; }
