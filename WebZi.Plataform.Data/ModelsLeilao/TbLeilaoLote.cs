...
public partial class TbLeilaoLote
{
    ...
    public virtual TbLotesStatus IdStatusLoteNavigation { get; set; }

    public virtual ICollection<TbLeilaoLotesProprietario> TbLeilaoLotesProprietarios { get; set; } = new List<TbLeilaoLotesProprietario>();

    public virtual ICollection<TbLeilaoLotesRestrico> TbLeilaoLotesRestricos { get; set; } = new List<TbLeilaoLotesRestrico>();

    public virtual ICollection<TbLeilaoLotesTransaco> TbLeilaoLotesTransacos { get; set; } = new List<TbLeilaoLotesTransaco>();
}
