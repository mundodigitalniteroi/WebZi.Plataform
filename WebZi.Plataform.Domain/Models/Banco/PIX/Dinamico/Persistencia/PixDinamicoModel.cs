...
namespace WebZi.Plataform.Domain.Models.Banco.PIX.Dinamico.Persistencia
{
    public class PixDinamicoModel
    {
        ...
        public byte PixDinamicoTipoStatusGeracaoId { get; set; } = 1;

        public int FaturamentoId { get; set; }

        /// <summary>
        /// TransactionId, também conhecido por txid
        /// </summary>
        ...
        public virtual ICollection<PixDinamicoConsultaModel> ListagemPixDinamicoConsulta { get; set; }
    }
}